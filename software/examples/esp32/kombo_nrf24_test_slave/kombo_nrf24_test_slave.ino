...
* об этом событии моргая светодиодом и выдавая сообщение в последовательный порт и bluetooth.
*
