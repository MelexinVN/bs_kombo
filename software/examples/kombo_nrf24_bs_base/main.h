...
#define RESET_BUTTONS		0xFF		//команда аппаратного сброса кнопок
#define SOFT_RESET			0xFE		//команда программного сброса
#define LED_STATE_ON		0x01		//команда включения светодиода
#define LED_STATE_OFF		0x00		//команда отключения светодиода
#define LED_BLINK_PERIOD	25			//период смены состояния моргающего светодиода
#define CMD_RESET			0x0B		//команда сброса всех кнопок
#define CMD_NEXT			0x0C		//команда перехода очереди
